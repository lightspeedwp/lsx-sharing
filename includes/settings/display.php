<div class="uix-field-wrapper">
	<ul class="ui-tab-nav">
		...
		<?php if ( class_exists( 'LSX_Currencies' ) ) { ?>
			...
			<li><a href="#ui-currencies" class="<?php echo esc_attr( $class_active ) ?>"><?php esc_html_e( 'Currencies', 'lsx-sharing' ); ?></a></li>
		<?php } ?>

		<?php if ( class_exists( 'LSX_Team' ) ) { ?>
			<?php $class_active = ( class_exists( 'LSX_Banners' ) || class_exists( 'LSX_Currencies' ) ) ? '' : 'active' ?>
			<li><a href="#ui-team" class="<?php echo esc_attr( $class_active ) ?>"><?php esc_html_e( 'Team', 'lsx-sharing' ); ?></a></li>
		<?php } ?>
		...
		<?php if ( class_exists( 'LSX_Testimonials' ) ) { ?>
			...
			<li><a href="#ui-testimonials" class="<?php echo esc_attr( $class_active ) ?>"><?php esc_html_e( 'Testimonials', 'lsx-sharing' ); ?></a></li>
		<?php } ?>
		...
		<?php if ( class_exists( 'LSX_Videos' ) ) { ?>
			...
			<li><a href="#ui-videos" class="<?php echo esc_attr( $class_active ) ?>"><?php esc_html_e( 'Videos', 'lsx-sharing' ); ?></a></li>
		<?php } ?>
		...
		<?php if ( class_exists( 'LSX_Search' ) ) { ?>
			...
			<li><a href="#ui-search" class="<?php echo esc_attr( $class_active ) ?>"><?php esc_html_e( 'Search', 'lsx-sharing' ); ?></a></li>
		<?php } ?>
	</ul>
